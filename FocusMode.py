...
if is_admin():
    ...
    print(current_time)
    time.sleep(2)
    website_list = ["www.facebook.com", "facebook.com", "www.youtube.com"]  # Enter the websites that you want to block
    ...
    while True:
        ...
        website_list = ["www.facebook.com", "facebook.com",
                        "www.youtube.com"]  # Enter the websites that you want to block
        if (current_time >= Stop_time):
